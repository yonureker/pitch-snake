...
insert into public.pitch_snake_items (id, kind, name, price, sort) values
  ...
  -- the template drop, 2026-09-10: seven PATTERNED bodies beside the
  -- founding five ramps, the owner's call that a skin is a template and
  -- not a recolour (rings, bands, stripes, an ember pulse; the clients'
  -- pattern tables own the look, these rows only name and price it)
  ('skin-ocean',   'skin', 'SEA KRAIT',     300, 35),
  ('skin-copper',  'skin', 'RATTLER',       300, 36),
