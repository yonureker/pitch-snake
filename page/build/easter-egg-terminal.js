...
export function initEasterEggTerminal() {
    ...
    const TERM_TEXT = `$ cat interview/top-10-at-scale.md
...
$ `;
    ...
    pEgg.addEventListener('click', () => { if (terminal.hidden)
        openTerminal();
    else
        closeTerminal(); });
    termClose.addEventListener('click', closeTerminal);
    document.addEventListener('keydown', (e) => { if (e.key === 'Escape' && !terminal.hidden)
        closeTerminal(); });
}
//# sourceMappingURL=easter-egg-terminal.js.map