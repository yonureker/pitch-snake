 ...
 */
export function resetVsSmoothing() {
    offX.fill(0);
    offY.fill(0);
    segN.fill(0);
    seenRollbacks = 0;
 ...
 */
export function smoothDepth(seat) {
 ...
 */
export function smoothX(seat, i) {
 ...
 */
export function smoothY(seat, i) {
 ...
 */
export function smoothOffX(seat, i) {
 ...
 */
export function smoothOffY(seat, i) {
 ...
 */
export function updateVsSmoothing(game, rollbacks, pulseMs, playing, posOf) {
