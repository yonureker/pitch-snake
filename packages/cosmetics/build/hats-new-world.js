...
export const NEW_WORLD_HATS = {
    ...
    'hat-chullo': {
        ...
        dy: (cellPixels, height) => -cellPixels * 0.3 - height * 0.42,
        draw(c, w, h) {
            // the knit dome
            c.fillStyle = '#2e7d84';
            c.beginPath();
    ...
    'hat-panama': {
        wf: 1.4, hf: 0.75,
        dy: (cellPixels, height) => -cellPixels * 0.42 - height * 0.58,
        draw(c, w, h) {
            const midX = w / 2;
            const brimY = h * 0.7;
    ...
    'hat-mountie': {
        wf: 1.5, hf: 0.8,
        dy: (cellPixels, height) => -cellPixels * 0.42 - height * 0.56,
        draw(c, w, h) {
            const midX = w / 2;
            const brimY = h * 0.7;
    ...
    'hat-cocar': {
        wf: 1.35, hf: 0.85,
        dy: (cellPixels, height) => -cellPixels * 0.36 - height * 0.5,
        draw(c, w, h) {
    ...
    'hat-bush': {
        wf: 1.4, hf: 0.7,
        dy: (cellPixels, height) => -cellPixels * 0.42 - height * 0.55,
        draw(c, w, h) {
            const midX = w / 2;
            const brimY = h * 0.66;
