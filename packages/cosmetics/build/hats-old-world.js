...
export const OLD_WORLD_HATS = {
    'hat-beret': {
        wf: 1.2, hf: 0.45,
        dy: (cellPixels, height) => -cellPixels * 0.42 - height * 0.45,
        draw(c, w, h) {
    ...
    'hat-topper': {
        ...
        wf: 1.2, hf: 0.95,
        dy: (cellPixels, height) => -cellPixels * 0.38 - height * 0.55,
        draw(c, w, h) {
            const brimY = h * 0.8;
    ...
    'hat-bowler': {
        wf: 1.15, hf: 0.65,
        dy: (cellPixels, height) => -cellPixels * 0.4 - height * 0.55,
        draw(c, w, h) {
            const brimY = h * 0.74;
            c.fillStyle = '#26232b';
    ...
    'hat-tam': {
        wf: 1.25, hf: 0.5,
        dy: (cellPixels, height) => -cellPixels * 0.4 - height * 0.45,
        draw(c, w, h) {
            ...
            c.moveTo(w * 0.38, h * 0.2);
            c.lineTo(w * 0.36, h * 0.78);
            c.stroke();
    ...
    'hat-fez': {
        ...
        wf: 1.05, hf: 0.72,
        dy: (cellPixels, height) => -cellPixels * 0.4 - height * 0.5,
        draw(c, w, h) {
    ...
    'hat-kufi': {
        wf: 0.95, hf: 0.42,
        dy: (cellPixels, height) => -cellPixels * 0.36 - height * 0.4,
        draw(c, w, h) {
    ...
    'hat-kepi': {
        wf: 0.95, hf: 0.55,
        dy: (cellPixels, height) => -cellPixels * 0.36 - height * 0.42,
        draw(c, w, h) {
    ...
    'hat-pith': {
        wf: 1.2, hf: 0.65,
        dy: (cellPixels, height) => -cellPixels * 0.38 - height * 0.5,
        draw(c, w, h) {
            const brimY = h * 0.7;
    ...
    'hat-bearskin': {
        ...
        wf: 0.95, hf: 1.05,
        dy: (cellPixels, height) => -cellPixels * 0.15 - height,
        draw(c, w, h) {
            ...
            c.lineWidth = Math.max(1, w * 0.05);
            c.beginPath();
            c.moveTo(w * 0.3, h * 0.2);
            c.lineTo(w * 0.27, h * 0.5);
            c.moveTo(w * 0.52, h * 0.14);
            c.lineTo(w * 0.5, h * 0.46);
            c.moveTo(w * 0.72, h * 0.2);
