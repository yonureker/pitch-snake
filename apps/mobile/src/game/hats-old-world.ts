...
export const OLD_WORLD_HATS: Record<string, HatArt> = {
  'hat-beret': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.08, h * 0.82);
        b.quadTo(w * 0.02, h * 0.3, w * 0.34, h * 0.2);
        b.quadTo(w * 0.72, h * 0.04, w * 0.95, h * 0.5);
        b.quadTo(w * 0.99, h * 0.78, w * 0.86, h * 0.84);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
  ...
  'hat-topper': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.16, brimY);
        b.lineTo(w * 0.13, h * 0.06);
        b.lineTo(w * 0.87, h * 0.06);
        b.lineTo(w * 0.84, brimY);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.02, brimY - h * 0.05);
        b.quadTo(w * 0.5, brimY + h * 0.2, w * 0.98, brimY - h * 0.05);
        b.quadTo(w * 0.5, brimY + h * 0.02, w * 0.02, brimY - h * 0.05);
        b.close();
      });
      c.drawPath(p2, paint);
      p2.dispose();
  ...
  'hat-bowler': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      // the hard round dome
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.14, brimY);
        b.quadTo(w * 0.14, h * 0.02, w * 0.5, h * 0.02);
        b.quadTo(w * 0.86, h * 0.02, w * 0.86, brimY);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.02, brimY - h * 0.1);
        b.quadTo(w * 0.5, brimY + h * 0.3, w * 0.98, brimY - h * 0.1);
        b.quadTo(w * 0.5, brimY + h * 0.06, w * 0.02, brimY - h * 0.1);
        b.close();
      });
      c.drawPath(p2, paint);
      p2.dispose();
  ...
  'hat-tam': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.1, h * 0.8);
        b.quadTo(w * 0.02, h * 0.24, w * 0.5, h * 0.18);
        b.quadTo(w * 0.98, h * 0.24, w * 0.9, h * 0.8);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.12, h * 0.52);
        b.lineTo(w * 0.88, h * 0.52);
        b.moveTo(w * 0.38, h * 0.2);
        b.lineTo(w * 0.36, h * 0.78);
      });
      ...
      const p3 = buildPath((b) => {
        b.moveTo(w * 0.1, h * 0.66);
        b.lineTo(w * 0.9, h * 0.66);
        b.moveTo(w * 0.62, h * 0.2);
        b.lineTo(w * 0.64, h * 0.78);
      });
      c.drawPath(p3, stroke);
      p3.dispose();
      paint.setColor(Skia.Color('#b03040')); // the toorie on top
      const p4 = buildPath((b) => {
        b.addCircle(w * 0.5, h * 0.14, w * 0.06);
      });
      c.drawPath(p4, paint);
      p4.dispose();
    },
  ...
  'hat-fez': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.08, h * 0.94);
        b.lineTo(w * 0.26, h * 0.1);
        b.lineTo(w * 0.74, h * 0.1);
        b.lineTo(w * 0.92, h * 0.94);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.5, h * 0.1);
        b.quadTo(w * 0.82, h * 0.16, w * 0.9, h * 0.52);
      });
      c.drawPath(p2, stroke);
      p2.dispose();
      paint.setColor(Skia.Color('#26232b'));
      const p3 = buildPath((b) => {
        b.addCircle(w * 0.9, h * 0.6, w * 0.07);
      });
      c.drawPath(p3, paint);
      p3.dispose();
    },
  ...
  'hat-kufi': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.05, h * 0.94);
        b.quadTo(w * 0.08, h * 0.06, w * 0.5, h * 0.04);
        b.quadTo(w * 0.92, h * 0.06, w * 0.95, h * 0.94);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
  ...
  'hat-kepi': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.08, h * 0.78);
        b.lineTo(w * 0.16, h * 0.1);
        b.lineTo(w * 0.84, h * 0.1);
        b.lineTo(w * 0.92, h * 0.78);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.18, h * 0.78);
        b.quadTo(w * 0.5, h * 1.04, w * 0.82, h * 0.78);
        b.quadTo(w * 0.5, h * 0.86, w * 0.18, h * 0.78);
        b.close();
      });
      c.drawPath(p2, paint);
      p2.dispose();
  ...
  'hat-pith': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.12, brimY);
        b.quadTo(w * 0.14, h * 0.06, w * 0.5, h * 0.04);
        b.quadTo(w * 0.86, h * 0.06, w * 0.88, brimY);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.02, brimY - h * 0.06);
        b.quadTo(w * 0.5, brimY + h * 0.34, w * 0.98, brimY - h * 0.06);
        b.quadTo(w * 0.5, brimY + h * 0.1, w * 0.02, brimY - h * 0.06);
        b.close();
      });
      c.drawPath(p2, paint);
      p2.dispose();
  ...
  'hat-fisher': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.06, h * 0.72);
        b.quadTo(w * 0.02, h * 0.1, w * 0.5, h * 0.08);
        b.quadTo(w * 0.96, h * 0.1, w * 0.94, h * 0.72);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p3 = buildPath((b) => {
        b.moveTo(w * 0.2, h * 0.74);
        b.quadTo(w * 0.5, h * 1.0, w * 0.8, h * 0.74);
        b.quadTo(w * 0.5, h * 0.82, w * 0.2, h * 0.74);
        b.close();
      });
      c.drawPath(p3, paint);
      p3.dispose();
  ...
  'hat-tyrol': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        ...
        b.lineTo(midX - w * 0.15, h * 0.2);
        b.quadTo(midX - w * 0.02, h * 0.06, midX + w * 0.08, h * 0.16);
      ...
      const p2 = buildPath((b) => {
        b.moveTo(midX - w * 0.34, brimY - h * 0.06);
        b.quadTo(midX, brimY + h * 0.26, midX + w * 0.34, brimY - h * 0.06);
        b.quadTo(midX, brimY + h * 0.04, midX - w * 0.34, brimY - h * 0.06);
        b.close();
      });
      c.drawPath(p2, paint);
      p2.dispose();
      ...
      const p3 = buildPath((b) => {
        b.moveTo(midX + w * 0.08, brimY - h * 0.12);
        b.quadTo(midX + w * 0.3, h * 0.3, midX + w * 0.4, h * 0.02);
      });
      c.drawPath(p3, stroke);
      p3.dispose();
    },
  ...
  'hat-bicorne': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.02, h * 0.28);
        b.quadTo(w * 0.5, h * -0.14, w * 0.98, h * 0.28);
        b.quadTo(w * 0.86, h * 0.9, w * 0.5, h * 0.94);
        b.quadTo(w * 0.14, h * 0.9, w * 0.02, h * 0.28);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.1, h * 0.42);
        b.quadTo(w * 0.5, h * 0.7, w * 0.9, h * 0.42);
      });
      c.drawPath(p2, stroke);
      p2.dispose();
      paint.setColor(Skia.Color('#d8b35e')); // the cockade
      const p3 = buildPath((b) => {
        b.addCircle(w * 0.5, h * 0.42, w * 0.05);
      });
      c.drawPath(p3, paint);
      p3.dispose();
    },
  ...
  'hat-bearskin': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.07, h * 0.96);
        b.lineTo(w * 0.09, h * 0.16);
        b.quadTo(w * 0.5, h * -0.04, w * 0.91, h * 0.16);
        b.lineTo(w * 0.93, h * 0.96);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      stroke.setStrokeWidth(Math.max(1, w * 0.05));
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.3, h * 0.2);
        b.lineTo(w * 0.27, h * 0.5);
        b.moveTo(w * 0.52, h * 0.14);
        b.lineTo(w * 0.5, h * 0.46);
        b.moveTo(w * 0.72, h * 0.2);
        b.lineTo(w * 0.74, h * 0.5);
      });
      c.drawPath(p2, stroke);
      p2.dispose();
