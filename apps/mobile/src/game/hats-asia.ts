...
export const ASIA_HATS: Record<string, HatArt> = {
  'hat-ushanka': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.08, h * 0.6);
        b.quadTo(w * 0.1, h * 0.08, w * 0.5, h * 0.06);
        b.quadTo(w * 0.9, h * 0.08, w * 0.92, h * 0.6);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.08, h * 0.62);
        b.quadTo(w * 0.06, h * 0.92, w * 0.2, h * 0.96);
        b.lineTo(w * 0.24, h * 0.7);
        b.close();
        b.moveTo(w * 0.92, h * 0.62);
        b.quadTo(w * 0.94, h * 0.92, w * 0.8, h * 0.96);
        b.lineTo(w * 0.76, h * 0.7);
        b.close();
      });
      c.drawPath(p2, paint);
      p2.dispose();
  ...
  'hat-turban': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.06, h * 0.9);
        b.quadTo(w * 0.06, h * 0.1, w * 0.5, h * 0.08);
        b.quadTo(w * 0.94, h * 0.1, w * 0.94, h * 0.9);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.12, h * 0.78);
        b.quadTo(w * 0.5, h * 0.3, w * 0.88, h * 0.78);
        b.moveTo(w * 0.2, h * 0.88);
        b.quadTo(w * 0.5, h * 0.52, w * 0.8, h * 0.88);
      });
      c.drawPath(p2, stroke);
      p2.dispose();
      paint.setColor(Skia.Color('#f4c14f')); // the front knot
      const p3 = buildPath((b) => {
        b.addCircle(w * 0.5, h * 0.28, w * 0.07);
      });
      c.drawPath(p3, paint);
      p3.dispose();
    },
  ...
  'hat-gat': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(midX - w * 0.16, brimY);
        b.lineTo(midX - w * 0.11, h * 0.06);
        b.lineTo(midX + w * 0.11, h * 0.06);
        b.lineTo(midX + w * 0.16, brimY);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(midX - w * 0.1, brimY + h * 0.08);
        b.lineTo(midX - w * 0.14, h * 0.98);
        b.moveTo(midX + w * 0.1, brimY + h * 0.08);
        b.lineTo(midX + w * 0.14, h * 0.98);
      });
      c.drawPath(p2, stroke);
  ...
  'hat-nonla': {
    ...
    draw(c: SkCanvas, w: number, h: number) {
      ...
      const p1 = buildPath((b) => {
        b.moveTo(w * 0.02, h * 0.9);
        b.quadTo(w * 0.3, h * 0.42, w * 0.5, h * 0.06);
        b.quadTo(w * 0.7, h * 0.42, w * 0.98, h * 0.9);
        b.close();
      });
      c.drawPath(p1, paint);
      p1.dispose();
      ...
      const p2 = buildPath((b) => {
        b.moveTo(w * 0.27, h * 0.52);
        b.quadTo(w * 0.5, h * 0.38, w * 0.73, h * 0.52);
      });
      c.drawPath(p2, stroke);
      p2.dispose();
    },
